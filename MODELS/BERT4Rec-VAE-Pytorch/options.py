...
parser.add_argument('--train_negative_sampling_seed', type=int, default=2022)
...
parser.add_argument('--test_negative_sampling_seed', type=int, default=408)
...
parser.add_argument('--model_init_seed', type=int, default=42)
# BERT #
parser.add_argument('--bert_max_len', type=int, default=150, help='Length of sequence for bert')
parser.add_argument('--bert_num_items', type=int, default=7608, help='Number of total items')
parser.add_argument('--bert_hidden_units', type=int, default=50, help='Size of hidden vectors (d_model)')
parser.add_argument('--bert_num_blocks', type=int, default=3, help='Number of transformer layers')
