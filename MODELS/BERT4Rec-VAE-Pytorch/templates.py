def set_template(args):
    if args.template is None:
        ...
        args.min_rating = 0 if args.dataset_code == 'ml-1m' else 0
        args.min_uc = 5
        args.min_sc = 0
        ...
        args.train_negative_sample_size = 1000
        args.train_negative_sampling_seed = 2022
