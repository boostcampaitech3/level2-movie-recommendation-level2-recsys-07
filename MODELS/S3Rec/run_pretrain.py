...
def main():
    ...
    args.checkpoint_path = os.path.join(args.output_dir, f"Pretrain_{args.data_name}_good.pt")

    os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu_id
    args.cuda_condition = torch.cuda.is_available() and not args.no_cuda

    # args.data_file = args.data_dir + args.data_name + '.txt'
    args.data_file = os.path.join(args.data_dir, "train_ratings_good_user.csv")
